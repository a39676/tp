package building.wechatPay_fromSDK.auth;
...
/** 微信支付认证凭据生成器 */
public class WechatPay2Credential implements Credential {
	...
	private String getToken(URI uri, String httpMethod, String signBody) {
		...
		String token = "mchid=\"" + getMerchantId() + "\"," + "nonce_str=\"" + nonceStr + "\"," + "timestamp=\""
				+ timestamp + "\"," + "serial_no=\"" + signature.getCertificateSerialNumber() + "\"," + "signature=\""
				+ signature.getSign() + "\"";
