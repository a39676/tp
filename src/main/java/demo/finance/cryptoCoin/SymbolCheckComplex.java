...
//		c.findDifferent();
	...
	public void checkForFuture() {
		...
		String inputStr = "AVAX, LINK, MATIC, ETC, XLM, FET, MKR, HBAR, ARB, IMX, OP, LDO, FTM, RUNE, STRK, AXS, ENS, BEAMX, SAND, GALA, GNO, ENA, MANA, CFX, MINA, ZK, SNX, ASTR, 1INCH, APE, LPT, KAVA, COMP, AEVO, WOO, CRV, SSV, RPL, DYDX, MEME, GLM, HOT, ENJ, ZRX, QTUM, ETHFI, RSR, METIS, MASK, T, LRC, VTHO, GLMR, BAL, ICX, ALT, RLC, MAGIC, IOST, CTSI, SLP, REQ, SNT, CVC, OMNI, KNC, AUCTION, PYR, SYS, MOVR, STEEM, HFT, BLZ, LQTY, BNT, FRONT, LOOM, ACA, AEUR, HIFI, NKN, WRX, MLN, QKC, CLV, ERN, REN, COS, DATA, WAN, AVA, VIC, FARM, KEY, ADX, AKRO, AST, OAX, PROS, FOR, CVP";
