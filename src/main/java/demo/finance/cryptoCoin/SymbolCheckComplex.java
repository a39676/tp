...
//		c.splitIntoGroup();
	...
	public void checkForFuture() {
		...
		String inputStr = "DUSK,FET,ARKM,DYM,CHR,PORTAL,RLC,TIA,AMB,LDO,PIXEL,PENDLE,BICO,AXL,TNSR,W,PHB,AI,CTSI,RIF,WLD,MAV,LEVER,TRU,LIT,NTRN,1000BONK,NMR,IOTX,PERP,HIGH,FTM,BAKE,OXT,CYBER,AVAX,SKL,KSM,MAGIC,KEY,BLZ,SPELL,ALPHA,FRONT,1INCH,OMNI,FXS,VANRY,LINA,YGG,REN,ONE,LPT,LOOM,XAI,MANTA,ALT,C98,INJ,ALGO,COMBO,HOT,GMX,NKN,1000FLOKI,API3,NEAR,KLAY,TLM,GRT,LQTY,MINA,BEAMX,JOE,STG,SNX,RSR,BOME,ICP,CELR,ORDI,ASTR,GALA,THETA,REEF,ENJ,DYDX,UMA,WOO";
