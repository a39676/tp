...
//		c.findDifferent();
	...
	public void checkForFuture() {
		...
		String inputStr = "FLM,NKN,ALGO,GMX,RONIN,RVN,IOST,REEF,APT,SUPER,XVG,SHIB,BOME,LSK,CHR,AR,SAND,EDU,ACH,ETC,BADGER,NEAR,LTC,ZIL,BONK,ID,INJ,XTZ,AXL,TWT,NEO,MTL,ZRX,AXS,ANKR,STEEM,SXP,FIL,DYM,T,ICX,WAXP,BAT,RUNE,ADA,JOE,DOGE,EOS,BEAMX,LUNC,ALICE,JASMY,STX,KNC,QTUM,VET,TIA,GAS,SFP,NTRN,EGLD,USTC,UMA,PYTH,BAND,MKR,IOTX,TAO,ACE,OXT,TRX,SKL,FLOW,SAGA,POWR,RIF,BCH,AUCTION,LOOM,HIFI,DASH,COTI,CRV,ICP,COMP,XLM,STORJ,JUP,XEC,XVS,JTO,AAVE,DAR,XRP,ZEN,AMB,ZEC,STMX";
