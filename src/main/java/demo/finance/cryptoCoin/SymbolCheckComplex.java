...
//		c.findDifferent();
	...
	public void checkForFuture() {
		...
		String inputStr = "ALT,PENDLE,ETHFI,W,OMNI,AI,STRK,MAV,FTM,PIXEL,UNFI,SSV,MEME,PEOPLE,DUSK,YGG,TRB,PORTAL,XAI,COMBO,BICO,ARKM,ENS,GTC,TNSR,LDO,ENA,UNI,PHB,RDNT,PERP,ROSE,RLC,APE,MAGIC,WOO,API3,ALPHA,SUSHI,GALA,C98,CYBER,ILV,HIGH,VANRY,ATA,LRC,TRU,NMR,LEVER,BLZ,SNX,HBAR,LPT,ATOM,CELR,ARB,MOVR,THETA,GRT,KSM,BEL,RSR,DENT,SUI,HFT,MASK,FRONT,FXS,DOT,LQTY,QNT,KEY,WIF,REN,CKB,AEVO,LINA,AGLD,STG,TLM,CHZ,ARK,MANTA,ORDI,HOT,1INCH,BLUR,KAVA,IMX,KLAY,NFP,LINK,POLYX,YFI,CAKE,ASTR,IOTA,METIS";
