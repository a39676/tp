...
//		c.splitIntoGroup();
	...
	public void checkForFuture() {
		...
		String inputStr = "JASMY,SHIB,BLZ,FTM,CKB,CRV,UNI,TIA,ENS,GRT,API3,HBAR,SPELL,HOT,STRK,MANA,MEME,STMX,TRU,UNFI,SUSHI,SUPER,KSM,LEVER,SAND,DYDX,FLOKI,LRC,RDNT,DOT,MATIC,BOME,1INCH,LINK,DENT,YFI,VET,GTC,FXS,CHR";
