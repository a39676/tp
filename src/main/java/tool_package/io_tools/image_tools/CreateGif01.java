...
public class CreateGif01 {
	...
	public static void generateFromFiles(List<String> filenames, String output, int delay, boolean loop)
			throws IIOException, IOException {
		int length = filenames.size();
		BufferedImage[] img_list = new BufferedImage[length];

		for (int i = 0; i < length; i++) {
			BufferedImage img = ImageIO.read(new File(filenames.get(i)));
			img_list[i] = img;
		}
	...
	public static void main(String[] args) {
		String[] img_strings = { "D:/auxiliary/tmp/01/BODY_monster_000001a_1-1.png",
				"D:/auxiliary/tmp/01/BODY_monster_000001a_1-2.png",
				"D:/auxiliary/tmp/01/BODY_monster_000001a_1-3.png",
				"D:/auxiliary/tmp/01/BODY_monster_000001a_1-4.png",
				"D:/auxiliary/tmp/01/BODY_monster_000001a_1-5.png",
				"D:/auxiliary/tmp/01/BODY_monster_000001a_1-6.png",
				"D:/auxiliary/tmp/01/BODY_monster_000001a_1-7.png",
				"D:/auxiliary/tmp/01/BODY_monster_000001a_1-8.png",
				"D:/auxiliary/tmp/01/BODY_monster_000001a_1-9.png",};
		
		List<String> imgList = new ArrayList<String>(Arrays.asList(img_strings));

		try {
			CreateGif01.generateFromFiles(imgList, "D:/auxiliary/tmp/01/output.gif", 15, true);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
